  ...
  return (
    <div className="min-h-screen bg-background text-on-surface flex flex-col items-center justify-center px-6 text-center">
      <div className="w-24 h-24 rounded-3xl bg-error/5 border border-error/10 flex items-center justify-center mb-6">
        <span className="font-serif text-3xl font-bold text-error/60">500</span>
      </div>
      <h1 className="font-serif text-2xl font-medium text-on-surface mb-2">Error del servidor</h1>
      <p className="text-sm text-on-surface-variant/60 max-w-xs mb-8 leading-relaxed">
        Ha ocurrido un error inesperado. Inténtalo de nuevo en unos momentos.
      </p>
